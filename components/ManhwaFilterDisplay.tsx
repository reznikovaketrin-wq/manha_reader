    ...
    <div className="w-full">
      ...
      <div className={styles.searchContainer}>
        <div className={styles.poda}>
          {/* Слой свечения для анимации */}
          <div className={styles.glow}></div>
          
          {/* Остальные слои (скрыты, но можно использовать для доп. эффектов) */}
          ...
          <div className={styles.main}>
            ...
            {/* Masks */}
            <div className={styles.inputMask} style={{ display: isFocused ? 'none' : 'block' }}></div>
